...
define('TWITTER_ID', "mypicmix");
define('FACEBOOK_ID', "mypicmix");
define('KEY_COOKIE', "picmix");
define("EXPIRED_COOKIE", 604800); //604800 : 7 day

define('BASE_URL', 'http://localhost/cms_ci');
...
//define('PATH_PROJECT', '/home/ickokidn/public_html/dev');
define('PATH_PROJECT', 'C:\wamp64\www\cms_ci');
define('PATH_ASSETS', PATH_PROJECT.'/assets');
define('BASE_URL_BACKEND', BASE_URL.'');
$view_path_backend = str_replace('\\','/',realpath($application_folder).'/views/');
