							  ...
							  <div class="box box-primary">
								  <section class="panel">
									  ...
									  <div class="panel-body">
										  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/user/doAdd'; ?>" method="post" class="form-horizontal" role="form">
											  <?php if(isset($error)){ ?>
											  ...
											  <div class="form-group">
												  ...
												  <div class="col-lg-4">
													  <input name="username" type="text" class="form-control" placeholder="User Name" value="<?php if(!empty($username)){echo $username;} ?>">
												  </div>
											  </div>
											  <div class="form-group">
												  <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Email</label>
												  <div class="col-lg-4">
													  <input name="email" type="text" class="form-control" placeholder="Email" value="<?php if(!empty($email)){echo $email;} ?>">
												  </div>
											  </div>
											  <div class="form-group">
