                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
								<div class="box-header">
                                    <h3 class="box-title">Module Group - List</h3>
									<div class="col-xs-12">
										<input class="btn btn-primary btn-sm" type="button" value="Add" onclick="window.location = '<?php echo BASE_URL_BACKEND;?>/module_group/add/'">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			table<?php echo $modul_id; ?> = $('#example1').dataTable({
				...
				"aaSorting": [[ 0, 'desc' ]],  
				"sAjaxSource": "<?php echo BASE_URL_BACKEND;?>/module_group/ajax_load",
				"sServerMethod": "POST",
				"aoColumnDefs": [
				...
				"aoColumns": [
								...
								{ mData: 'module_group_create_date' },
								{ mData: 'module_group_order_value_text' },
								{ mData: 'module_group_action', sClass: 'text-center' },
							],
