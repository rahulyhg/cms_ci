							  ...
							  <div class="box box-primary">
								  <section class="panel">
									  ...
									  <div class="panel-body">
										  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/module_group/doAdd'; ?>" method="post" class="form-horizontal" role="form">
											  <?php if(isset($error)){ ?>
											  ...
											  <div class="form-group">
												  ...
												  <div class="col-lg-4">
													  <input name="groupname" type="text" class="form-control"placeholder="Module Group Name" value="<?php if(!empty($groupname)){echo $groupname;} ?>">
												  </div>
											  </div>
											  <div class="form-group">
